...
export interface LandingPageContent {
    ...
    pricing_old_price: string;
    pricing_price: string;
    pricing_price_suffix: string;
    pricing_feature1: string;
    pricing_feature2: string;
    pricing_feature3: string;
    pricing_feature4: string;
    pricing_feature5: string;
