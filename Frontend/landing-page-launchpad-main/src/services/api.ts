...
export interface LandingPageContent {
    ...
    problem1_description: string;
    problem2_title: string;
    problem2_description: string;
    problem3_title: string;
    problem3_description: string;
    problem4_title: string;
    problem4_description: string;
    problem5_title: string;
    problem5_description: string;
    solution_section_label: string;
    solution_section_title: string;
    solution1_title: string;
    solution1_desc: string;
    solution2_title: string;
    solution2_desc: string;
    solution3_title: string;
    solution3_desc: string;
    solution4_title: string;
    solution4_desc: string;
    solution5_title: string;
    solution5_desc: string;
    solution6_title: string;
    solution6_desc: string;
    ...
    usp_feature1_title: string;
    usp_feature1_desc: string;
    usp_feature2_title: string;
    usp_feature2_desc: string;
    usp_feature3_title: string;
    usp_feature3_desc: string;
    howitworks_label: string;
    howitworks_title: string;
    howitworks_desc: string;
    howitworks_step1_title: string;
    howitworks_step1_desc: string;
    howitworks_step2_title: string;
    howitworks_step2_desc: string;
    howitworks_step3_title: string;
    howitworks_step3_desc: string;
    ...
    referral_item1_value: string;
    referral_item1_text: string;
    referral_item2_value: string;
    referral_item2_text: string;
    referral_item3_value: string;
    referral_item3_text: string;
