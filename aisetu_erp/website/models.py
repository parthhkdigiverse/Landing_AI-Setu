...
class Problem(models.Model):
    ...
    icon = models.CharField(
        max_length=50,
        help_text="Lucide icon name (e.g. Clock, Package, TrendingDown, Users, Barcode). See lucide.dev for all options."
    )
...
class Feature(models.Model):
    ...
    icon = models.CharField(
        max_length=50,
        help_text="Lucide icon name (e.g. Zap, BarChart3, Shield). See lucide.dev for all options."
    )
...
class USPFeature(models.Model):
    ...
    icon = models.CharField(max_length=50, help_text="Lucide icon name (e.g. Star, Zap, Activity). See lucide.dev")
...
class HowItWorksStep(models.Model):
    ...
    icon = models.CharField(max_length=50, help_text="Lucide icon name (e.g. Search, Pencil, Check). See lucide.dev")
...
class StoreType(models.Model):
    ...
    icon = models.CharField(max_length=50, help_text="Lucide icon name (e.g. Store, ShoppingBag, Truck). See lucide.dev")
...
class ReferralPerk(models.Model):
    ...
    icon = models.CharField(max_length=50, help_text="Lucide icon name (e.g. Gift, Tag, Ticket). See lucide.dev")
...
class SocialLink(models.Model):
    ...
    platform = models.CharField(max_length=50)  # e.g., Facebook, Instagram, etc.
    url = models.URLField()
    is_active = models.BooleanField(default=True)
    order = models.IntegerField(default=0)
...
class Culture(models.Model):
    ...
    icon = models.CharField(max_length=100, blank=True, help_text="Lucide icon name (e.g. Heart, Target, Users). See lucide.dev")
