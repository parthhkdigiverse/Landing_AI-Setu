...
from .views import book_demo_api,login_view,pricing_signup, phonepe_initiate_payment, phonepe_callback, landing_page_content_api, submit_contact, apply_job, check_referral
from . import views 
urlpatterns = [    
